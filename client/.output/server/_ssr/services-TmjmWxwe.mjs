...
//#region node_modules/.nitro/vite/services/ssr/assets/services-TmjmWxwe.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Технологический аудит, инженерные расчёты, лаборатория неразрушающего контроля, сертификация СМК, метрологическая экспертиза. Раздел в разработке."
			})
		]
	});
}
